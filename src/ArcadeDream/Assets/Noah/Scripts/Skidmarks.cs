...
namespace CarGame
{
    ...
    public class Skidmarks : MonoBehaviour
    {
        ...
        const int MAX_MARKS = 8192; //4096; //2048; // Max number of marks total for everyone together
        const float MARK_WIDTH = 0.15f; // Width of the skidmarks. Should match the width of the wheels
        ...
        void UpdateSkidmarksMesh()
        {
            ...
            colors[markIndex * 4 + 0] = new Color32(201, 202, 121, last.Intensity); //change skidmark color change all 4
            colors[markIndex * 4 + 1] = new Color32(201, 202, 121, last.Intensity);
            colors[markIndex * 4 + 2] = new Color32(201, 202, 121, curr.Intensity);
            colors[markIndex * 4 + 3] = new Color32(201, 202, 121, curr.Intensity);
